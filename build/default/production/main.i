...
void main(void)
{
    ...
    (INTCONbits.PEIE = 1);
     ...
     int x=0;
     do { LATAbits.LATA0 = 1; } while(0);do { LATAbits.LATA1 = 1; } while(0); do { LATAbits.LATA2 = 1; } while(0); do { LATAbits.LATA3 = 1; } while(0);do { LATAbits.LATA4 = 1; } while(0);do { LATAbits.LATA5 = 1; } while(0);do { LATAbits.LATA6 = 1; } while(0);
